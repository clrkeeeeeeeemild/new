...
define('CAMPAIGN_ID', "bcadcd82ed6bbf612564534a9de090fa");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'cdeb034c3ff31853a857ddf66d9fb43c');
define('MP_PARAM_NAME', '_pk_clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '1b6256b8114e6d64bd7f029650c0e332');
define('CHECK_MCPROXY_VALUE', 'f973f79034d1f8fdaa4c071088467e7dec7d9b6f63f38cd1c7ca0120fc6a02da');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '13713.3');
